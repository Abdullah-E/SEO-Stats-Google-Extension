...
function Card2() {
  const card2Data = [
    { id: "1", words: "33 كلمة", price: "9.90" },
    { id: "2", words: "76 كلمة", price: "19.90" },
    { id: "3", words: "120 كلمة", price: "29.90" },
  ];
            ...
            {card2Data.map((item) => (
              <tr key={item.id}>
                ...
                <td className="text-center">
                  <span className="py-[2px] bg-custom-dark-blue text-white text-xl md:text-lg lg:text-2xl font-bold rounded-full flex items-center justify-center gap-[2px]">
